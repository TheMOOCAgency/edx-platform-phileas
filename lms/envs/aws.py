...
ENROLLMENT_REQUEST_EMAIL = ENV_TOKENS.get('ENROLLMENT_REQUEST_EMAIL', ENROLLMENT_REQUEST_EMAIL)
...
IDENTITY_PROOF_SECRET_KEY = AUTH_TOKENS.get('IDENTITY_PROOF_SECRET_KEY', IDENTITY_PROOF_SECRET_KEY)
