  ...
  this.DiscussionUtil = (function() {
    ...
    DiscussionUtil.discussionAlert = function(header, body) {
      ...
      if ($("#discussion-alert").length === 0) {
        ...
        alertDiv.html("<div class='inner-wrapper discussion-alert-wrapper'>" + "  <button class='close-modal dismiss' title='" + gettext("Close") + "'><span class='icon fa fa-times' aria-hidden='true'></span></button>" + "  <header><h2/><hr/></header>" + "  <p id='discussion-alert-message'/>" + "  <hr/>" + "  <button class='dismiss'>" + gettext("OK") + "</button>" + "</div>");
